...
// Regenerate: FIGMA_TOKEN=your_token node scripts/generate-theme.js

import { alpha, createTheme, lighten, darken } from '@mui/material';

const themeColors = {
	primary:    '#5569ff', // Figma: Brand/Blue/500
	secondary:  '#6e759f', // Figma: System/Secondary/500
	success:    '#00a76f', // Figma: System/Success/500
	warning:    '#ffa319', // Figma: System/Warning/500
	error:      '#ff1943', // Figma: System/Error/500
	info:       '#33c2ff', // Figma: System/Info/500
	black:      '#223354', // Figma: System/Black
	white:      '#ffffff',
	primaryAlt: '#000a58', // Figma: Brand/Blue/900
};
...
export const PureLightTheme = createTheme({
	...
	general: {
		...
		borderRadiusSm: '6px',  // Figma: Border Radius/MD
		borderRadius: '10px',   // Figma: Border Radius/Content
		borderRadiusLg: '12px', // Figma: Border Radius/LG
		borderRadiusXl: '16px', // Figma: Border Radius/Content-XL
	},
	sidebar: {
		...
		RaSavedQueriesList: {
			styleOverrides: {
				root: {
					...
					'& .RaSavedQueriesList-floatingIcon': {
						top: '-2.5em',
					},
					'& .MuiListItemButton-root.RaSavedQueryFilterListItem-listItemButton': {
						paddingRight: '3em',
					},
				},
				floatingIcon: {
		...
		MuiMenuItem: {
			styleOverrides: {
				root: {
					...
					'&:hover, &:active, &.active, &.Mui-selected': {
						color: colors.alpha.white[100],
						background: colors.alpha.white[7],
					},
					'&.Mui-selected:hover': {
						background: alpha(colors.primary.lighter, 0.4),
					},
